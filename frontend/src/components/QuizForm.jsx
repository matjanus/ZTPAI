...
//       alert('Wprowadź tytuł i przynajmniej jedną parę słów.');
//       return;
//     }

//     // Tu można wysłać do backendu
//     console.log('Dane do wysłania:', { title, pairs: cleanedPairs });
//     // np. axios.post('/api/quiz', { title, pairs: cleanedPairs })
//   };
...
//       <button type="submit" className="submit-btn">Dodaj quiz</button>
//     </form>
//   );
// }
